        ...
        <ul>
            ...
            <li class="nav-item">
                <a href="{{route('kasbon.index')}}">
                    <span class="icon">
                        <svg id="Activity" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <g id="Iconly/Light-Outline/Activity" stroke="none" stroke-width="1.5" fill="none"
                                fill-rule="evenodd">
                                <g id="Activity" transform="translate(2.000000, 2.000000)" fill="currentColor">
                                    <path
